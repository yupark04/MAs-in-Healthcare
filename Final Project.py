...
def perform_individual_regression(df_dict):
    ...
    for company, df in df_dict.items():
        ...
        group = df['Group'].iloc[0] # accessing group label for each company
        # assigning label based off group binary value 
...
def main():
    ...
    # Assigning binary values to each company for graphing purposes 
